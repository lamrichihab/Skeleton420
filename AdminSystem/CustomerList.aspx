...
<body>
    <form id="form2" runat="server" class="form-container">
        ...
        <div class="listbox-container">
            <asp:ListBox ID="lstCustomerList" runat="server" Height="258px" Width="573px"></asp:ListBox>
        </div>
        ...
        <div class="button-group spacer">
            <asp:Button ID="btnApply" runat="server" OnClick="btnApply_Click" Text="Apply" CssClass="inline" />
            <asp:Button ID="btnClear" runat="server" OnClick="btnClear_Click" Text="Clear" CssClass="inline" />
            <asp:Button ID="btnReturn" runat="server" Text="Return to Main Menu" />
        </div>
