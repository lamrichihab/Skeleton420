...
<body>
    <form id="form1" runat="server" class="form-container">
        ...
        <div class="listbox-container">
            <asp:ListBox ID="lstSupplierList" runat="server" Height="258px" Width="573px"></asp:ListBox>
        </div>
        ...
        <div class="form-group spacer">
            <asp:Label ID="lblStatement" runat="server" Text="Filter by Supplier Name"></asp:Label>
